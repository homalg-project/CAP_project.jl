...
#!  * `commutative_semiring_of_linear_category` (optional): ring attached as <Ref Attr="CommutativeSemiringOfLinearCategory" Label="for IsCapCategory" /> to the category
