...
@InstallGlobalFunction( CAP_INTERNAL_ENHANCE_NAME_RECORD,
  function( record )
    ...
    for current_recname in recnames
        ...
        if (ForAll( current_rec.filter_list, x -> x in [ "element_of_commutative_semiring_of_linear_structure", "integer", "nonneg_integer_or_infinity", "category", "object", "object_in_range_category_of_homomorphism_structure", "list_of_objects" ] ))
